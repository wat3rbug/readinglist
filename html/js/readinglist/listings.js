                ...
                success: function(listings) {
                    for( i = 0; i < categories.length; i++) {
                        ...
                        if (listByCat.length > 0) {
                            ...
                            card += cat + '</a>&nbsp;<button type="button" class="btn btn-link" onclick="performCollapse(&#39;'
                            card += no_space + '&#39;)"><span id="' + no_space + '_icon" class="glyphicon glyphicon-chevron-up"></span></button></div>';
                            card += '<div class="card-body" id="' + no_space + '">';                    
...
function performCollapse(section) {
